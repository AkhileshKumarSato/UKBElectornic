                    ...
                    while (!_sr.EndOfStream)
                    {
                        ...
                        switch (_strArr[0])
                        {
                            ...
                            case "PRINTER_NAME":
                                ...
                                break;
                            case "ProductQRPortNo":
                                GlobalVariable.ProductQRPortNo = _strArr[1].ToString().Trim();
                                break;
                            case "MRPQRPortNo":
                                GlobalVariable.MRPQRPortNo = _strArr[1].ToString().Trim();
                                break;
                            case "CARTONQRPortNo":
                                GlobalVariable.CARTONQRPortNo = _strArr[1].ToString().Trim();
                                break;
                        }
                    }
                    _sr.Close();
