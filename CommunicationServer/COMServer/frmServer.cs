...
namespace COMServer
{
    public partial class frmServer : Form
    {
        ...
        private void connectServer()
        {
            ...
            oLog.LogDays = 15;
           // string sss =new clsSecurity().DecryptString("2F9qJa9k3WmT8SJoLZdEKBoMXvEjRH7okF0H7/O/GQjkCPIDWiblb5LNimTONgg0");
                ...
                try
                {
                    switch (Data[0])
                    {
                        ...
                        case "V_USER":
                            ...
                            Response = objSecurity.ManageUser(new User { DbType= "VALIDATEUSER", UserId = Data[1], Password = Data[2],Plant=Data[3] });
                            objSecurity = null;
                            break;
                        case "GET_USER_RIGHT":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.ManageGroupRights(new User { Group = Data[1] });
                            objSecurity = null;
                            break;
                        case "IN_AND_OUT":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.ManageInAndOut(new InAndOut { DbType = Data[1], FromPlant = Data[2], ToPlant = Data[3], DocNo = Data[4], RFIDTag = Data[5], CreatedBy = Data[6] });
                            objSecurity = null;
                            break;
                        case "IN_AND_OUT_RCV":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.ManageInAndOut_RCV(new InAndOut { DbType = Data[1], FromPlant = Data[2], ToPlant = Data[3], DocNo = Data[4], RFIDTag = Data[5], CreatedBy = Data[6] });
                            objSecurity = null;
                            break;
        ...
        private void frmServer_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string ds = new clsSecurity().DecryptString("jh+PsoEe02fg+Us+/Ev54usukE8LS9LOKFhe/H8BkDjwuCGISyo8X5KaJHM7nRRG");
            }
            catch (Exception ex)
            {
